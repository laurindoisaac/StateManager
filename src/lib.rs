...
#[derive(Debug)]
pub struct StateManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StateManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StateManager processing");
    
    let mut processor = StateManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StateManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StateManagerProcessor::new(false);
